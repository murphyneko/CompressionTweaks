...
public class CTRegion extends Region {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        ...
        this.addModifiedVanillaOverworldBiomes(mapper, builder -> {
            ...
            builder.replaceBiome(Biomes.MEADOW, CTBiomes.MYSTICAL_GROVE);
            builder.replaceBiome(Biomes.DARK_FOREST, CTBiomes.GLIMMERING_WEALD);
            builder.replaceBiome(Biomes.SWAMP, CTBiomes.SCULK_LANDS);
        });
    }
}