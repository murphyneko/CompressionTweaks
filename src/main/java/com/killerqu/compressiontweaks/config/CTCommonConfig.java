...
public class CTCommonConfig {
    ...
    static {
        ...
        CENTRIFUGE_FLUID_CAPACITY = BUILDER.comment("The capacity of the internal tanks for the Vintage Improvements centrifuge")
                .define("VI Centrifuge Fluid Capacity", 1000);
